...
#ifndef __SQ_OTG_HS_H__
#define __SQ_OTG_HS_H__
...
#if 1
#define SQ_USBD_DETECT_IRQ()	(readl(0x7C000000 + 0x014) & 0x800c3810)
#define SQ_USBD_CLEAR_IRQ()	do { \
					writel(BIT_ALLMSK, (0x7C000000+0x014)); \
				} while (0)
#else
#define SQ_USBD_DETECT_IRQ()	(readl(0x71300008) & (1<<26))
#define SQ_USBD_CLEAR_IRQ()	do { \
...
#define SQ_OTG_DIEPCTL_IN	(SQ_OTG_DIEPCTL0 + 0x20*BULK_IN_EP)
#define SQ_OTG_DIEPINT_IN	(SQ_OTG_DIEPINT0 + 0x20*BULK_IN_EP)
#define SQ_OTG_DIEPTSIZ_IN	(SQ_OTG_DIEPTSIZ0 + 0x20*BULK_IN_EP)
#define SQ_OTG_DIEPDMA_IN	(SQ_OTG_DIEPDMA0 + 0x20*BULK_IN_EP)
#define SQ_OTG_DOEPCTL_OUT	(SQ_OTG_DOEPCTL0 + 0x20*BULK_OUT_EP)
#define SQ_OTG_DOEPINT_OUT	(SQ_OTG_DOEPINT0 + 0x20*BULK_OUT_EP)
#define SQ_OTG_DOEPTSIZ_OUT	(SQ_OTG_DOEPTSIZ0 + 0x20*BULK_OUT_EP)
#define SQ_OTG_DOEPDMA_OUT	(SQ_OTG_DOEPDMA0 + 0x20*BULK_OUT_EP)
#define SQ_OTG_IN_FIFO		(SQ_OTG_EP0_FIFO + 0x1000*BULK_IN_EP)
#define SQ_OTG_OUT_FIFO	(SQ_OTG_EP0_FIFO + 0x1000*BULK_OUT_EP)
...
/* in usbd-otg-hs.c */
extern unsigned int sq_usbd_dn_addr;
extern unsigned int sq_usbd_dn_cnt;
extern int DNW;
extern int sq_got_header;
extern int sq_receive_done;
