...
/*
 * Date & Time support for the built-in SQ SQ8612 RTC
 */

#include <common.h>
#include <command.h>

#if defined(CONFIG_RTC_SQ8612) && (CONFIG_COMMANDS & CFG_CMD_DATE)
...
{
	SQ8612_RTC * const rtc = SQ8612_GetBase_RTC();
	switch (a) {
		case RTC_ENABLE:
...
#endif	/* CONFIG_RTC_SQ8612 && CFG_CMD_DATE */
