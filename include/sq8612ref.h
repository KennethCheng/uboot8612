 ...
 *  $Id: sq8612ref.h,v 1.19 2008/04/10 01:36:30 jsgood Exp $
 *
 ...
 * NAME	    : sq8612ref.h
 *
 * Based on SQ8612 User's manual Rev 0.0
 ************************************************/

#ifndef __SQ8612REF_H__
#define __SQ8612REF_H__

#ifndef CONFIG_SQ8612
#define CONFIG_SQ8612		1
#endif

#define SQ8612_UART_CHANNELS	3
#define SQ8612_SPI_CHANNELS	2
...
/*
 * Command Mapping for SQ8612 OneNAND Controller
 */
...
#define SQ_OTG_GOTGCTL		(USBOTG_LINK_BASE + 0x000)	/* OTG Control & Status */
#define SQ_OTG_GOTGINT		(USBOTG_LINK_BASE + 0x004)	/* OTG Interrupt */
#define SQ_OTG_GAHBCFG		(USBOTG_LINK_BASE + 0x008)	/* Core AHB Configuration */
#define SQ_OTG_GUSBCFG		(USBOTG_LINK_BASE + 0x00C)	/* Core USB Configuration */
#define SQ_OTG_GRSTCTL		(USBOTG_LINK_BASE + 0x010)	/* Core Reset */
#define SQ_OTG_GINTSTS		(USBOTG_LINK_BASE + 0x014)	/* Core Interrupt */
#define SQ_OTG_GINTMSK		(USBOTG_LINK_BASE + 0x018)	/* Core Interrupt Mask */
#define SQ_OTG_GRXSTSR		(USBOTG_LINK_BASE + 0x01C)	/* Receive Status Debug Read/Status Read */
#define SQ_OTG_GRXSTSP		(USBOTG_LINK_BASE + 0x020)	/* Receive Status Debug Pop/Status Pop */
#define SQ_OTG_GRXFSIZ		(USBOTG_LINK_BASE + 0x024)	/* Receive FIFO Size */
#define SQ_OTG_GNPTXFSIZ	(USBOTG_LINK_BASE + 0x028)	/* Non-Periodic Transmit FIFO Size */
#define SQ_OTG_GNPTXSTS	(USBOTG_LINK_BASE + 0x02C)	/* Non-Periodic Transmit FIFO/Queue Status */

#define SQ_OTG_HPTXFSIZ	(USBOTG_LINK_BASE + 0x100)	/* Host Periodic Transmit FIFO Size */
#define SQ_OTG_DPTXFSIZ1	(USBOTG_LINK_BASE + 0x104)	/* Device Periodic Transmit FIFO-1 Size */
#define SQ_OTG_DPTXFSIZ2	(USBOTG_LINK_BASE + 0x108)	/* Device Periodic Transmit FIFO-2 Size */
#define SQ_OTG_DPTXFSIZ3	(USBOTG_LINK_BASE + 0x10C)	/* Device Periodic Transmit FIFO-3 Size */
#define SQ_OTG_DPTXFSIZ4	(USBOTG_LINK_BASE + 0x110)	/* Device Periodic Transmit FIFO-4 Size */
#define SQ_OTG_DPTXFSIZ5	(USBOTG_LINK_BASE + 0x114)	/* Device Periodic Transmit FIFO-5 Size */
#define SQ_OTG_DPTXFSIZ6	(USBOTG_LINK_BASE + 0x118)	/* Device Periodic Transmit FIFO-6 Size */
#define SQ_OTG_DPTXFSIZ7	(USBOTG_LINK_BASE + 0x11C)	/* Device Periodic Transmit FIFO-7 Size */
#define SQ_OTG_DPTXFSIZ8	(USBOTG_LINK_BASE + 0x120)	/* Device Periodic Transmit FIFO-8 Size */
#define SQ_OTG_DPTXFSIZ9	(USBOTG_LINK_BASE + 0x124)	/* Device Periodic Transmit FIFO-9 Size */
#define SQ_OTG_DPTXFSIZ10	(USBOTG_LINK_BASE + 0x128)	/* Device Periodic Transmit FIFO-10 Size */
#define SQ_OTG_DPTXFSIZ11	(USBOTG_LINK_BASE + 0x12C)	/* Device Periodic Transmit FIFO-11 Size */
#define SQ_OTG_DPTXFSIZ12	(USBOTG_LINK_BASE + 0x130)	/* Device Periodic Transmit FIFO-12 Size */
#define SQ_OTG_DPTXFSIZ13	(USBOTG_LINK_BASE + 0x134)	/* Device Periodic Transmit FIFO-13 Size */
#define SQ_OTG_DPTXFSIZ14	(USBOTG_LINK_BASE + 0x138)	/* Device Periodic Transmit FIFO-14 Size */
#define SQ_OTG_DPTXFSIZ15	(USBOTG_LINK_BASE + 0x13C)	/* Device Periodic Transmit FIFO-15 Size */
	
/* Host Global Registers */
#define SQ_OTG_HCFG		(USBOTG_LINK_BASE + 0x400)	/* Host Configuration */
#define SQ_OTG_HFIR		(USBOTG_LINK_BASE + 0x404)	/* Host Frame Interval */
#define SQ_OTG_HFNUM		(USBOTG_LINK_BASE + 0x408)	/* Host Frame Number/Frame Time Remaining */
#define SQ_OTG_HPTXSTS		(USBOTG_LINK_BASE + 0x410)	/* Host Periodic Transmit FIFO/Queue Status */
#define SQ_OTG_HAINT		(USBOTG_LINK_BASE + 0x414)	/* Host All Channels Interrupt */
#define SQ_OTG_HAINTMSK	(USBOTG_LINK_BASE + 0x418)	/* Host All Channels Interrupt Mask */

/* Host Port Control & Status Registers */
#define SQ_OTG_HPRT		(USBOTG_LINK_BASE + 0x440)	/* Host Port Control & Status */

/* Host Channel-Specific Registers */
#define SQ_OTG_HCCHAR0		(USBOTG_LINK_BASE + 0x500)	/* Host Channel-0 Characteristics */
#define SQ_OTG_HCSPLT0		(USBOTG_LINK_BASE + 0x504)	/* Host Channel-0 Split Control */
#define SQ_OTG_HCINT0		(USBOTG_LINK_BASE + 0x508)	/* Host Channel-0 Interrupt */
#define SQ_OTG_HCINTMSK0	(USBOTG_LINK_BASE + 0x50C)	/* Host Channel-0 Interrupt Mask */
#define SQ_OTG_HCTSIZ0		(USBOTG_LINK_BASE + 0x510)	/* Host Channel-0 Transfer Size */
#define SQ_OTG_HCDMA0		(USBOTG_LINK_BASE + 0x514)	/* Host Channel-0 DMA Address */

	
/* Device Global Registers */
#define SQ_OTG_DCFG		(USBOTG_LINK_BASE + 0x800)	/* Device Configuration */
#define SQ_OTG_DCTL		(USBOTG_LINK_BASE + 0x804)	/* Device Control */
#define SQ_OTG_DSTS		(USBOTG_LINK_BASE + 0x808)	/* Device Status */
#define SQ_OTG_DIEPMSK 	(USBOTG_LINK_BASE + 0x810)	/* Device IN Endpoint Common Interrupt Mask */
#define SQ_OTG_DOEPMSK 	(USBOTG_LINK_BASE + 0x814)	/* Device OUT Endpoint Common Interrupt Mask */
#define SQ_OTG_DAINT		(USBOTG_LINK_BASE + 0x818)	/* Device All Endpoints Interrupt */
#define SQ_OTG_DAINTMSK	(USBOTG_LINK_BASE + 0x81C)	/* Device All Endpoints Interrupt Mask */
#define SQ_OTG_DTKNQR1 	(USBOTG_LINK_BASE + 0x820)	/* Device IN Token Sequence Learning Queue Read 1 */
#define SQ_OTG_DTKNQR2 	(USBOTG_LINK_BASE + 0x824)	/* Device IN Token Sequence Learning Queue Read 2 */
#define SQ_OTG_DVBUSDIS	(USBOTG_LINK_BASE + 0x828)	/* Device VBUS Discharge Time */
#define SQ_OTG_DVBUSPULSE	(USBOTG_LINK_BASE + 0x82C)	/* Device VBUS Pulsing Time */
#define SQ_OTG_DTKNQR3 	(USBOTG_LINK_BASE + 0x830)	/* Device IN Token Sequence Learning Queue Read 3 */
#define SQ_OTG_DTKNQR4 	(USBOTG_LINK_BASE + 0x834)	/* Device IN Token Sequence Learning Queue Read 4 */
	
/* Device Logical IN Endpoint-Specific Registers */
#define SQ_OTG_DIEPCTL0	(USBOTG_LINK_BASE + 0x900)	/* Device IN Endpoint 0 Control */
#define SQ_OTG_DIEPINT0	(USBOTG_LINK_BASE + 0x908)	/* Device IN Endpoint 0 Interrupt */
#define SQ_OTG_DIEPTSIZ0	(USBOTG_LINK_BASE + 0x910)	/* Device IN Endpoint 0 Transfer Size */
#define SQ_OTG_DIEPDMA0	(USBOTG_LINK_BASE + 0x914)	/* Device IN Endpoint 0 DMA Address */

/* Device Logical OUT Endpoint-Specific Registers */
#define SQ_OTG_DOEPCTL0	(USBOTG_LINK_BASE + 0xB00)	/* Device OUT Endpoint 0 Control */
#define SQ_OTG_DOEPINT0	(USBOTG_LINK_BASE + 0xB08)	/* Device OUT Endpoint 0 Interrupt */
#define SQ_OTG_DOEPTSIZ0	(USBOTG_LINK_BASE + 0xB10)	/* Device OUT Endpoint 0 Transfer Size */
#define SQ_OTG_DOEPDMA0	(USBOTG_LINK_BASE + 0xB14)	/* Device OUT Endpoint 0 DMA Address */
	
/* Power & clock gating registers */
#define SQ_OTG_PCGCCTRL	(USBOTG_LINK_BASE + 0xE00)

/* Endpoint FIFO address */
#define SQ_OTG_EP0_FIFO	(USBOTG_LINK_BASE + 0x1000)

 

/* OTG PHY CORE REGISTERS */
#define SQ_OTG_PHYPWR		(USBOTG_PHY_BASE+0x00)
#define SQ_OTG_PHYCTRL		(USBOTG_PHY_BASE+0x04)
#define SQ_OTG_RSTCON		(USBOTG_PHY_BASE+0x08)

/* include common stuff */
#ifndef __ASSEMBLY__
static inline SQ8612_MEMCTL * SQ8612_GetBase_MEMCTL(void)
{
	return (SQ8612_MEMCTL *)(ELFIN_DMC0_BASE);
}
static inline SQ8612_USB_HOST * SQ8612_GetBase_USB_HOST(void)
{
	return (SQ8612_USB_HOST *)ELFIN_USB_HOST_BASE;
}
static inline SQ8612_INTERRUPT * SQ8612_GetBase_INTERRUPT(void)
{
	return (SQ8612_INTERRUPT *)ELFIN_VIC0_BASE_ADDR;
}
static inline SQ8612_DMAS * SQ8612_GetBase_DMAS(void)
{
	return (SQ8612_DMAS *)ELFIN_DMA_BASE;
}
static inline SQ8612_CLOCK_POWER * SQ8612_GetBase_CLOCK_POWER(void)
{
	return (SQ8612_CLOCK_POWER *)ELFIN_CLOCK_POWER_BASE;
}
static inline SQ8612_LCD * SQ8612_GetBase_LCD(void)
{
	return (SQ8612_LCD *)ELFIN_LCD_BASE;
}
/*
static inline SQ8612_NAND * S3C2410_GetBase_NAND(void)
{
	return (SQ8612_NAND *)ELFIN_NAND_BASE;
}
*/
static inline SQ8612_UART * SQ8612_GetBase_UART(SQ8612_UARTS_NR nr)
{
//	return (SQ8612_UART *)(ELFIN_UART_BASE + (nr * 0x4000));
	return (SQ8612_UART *)(ELFIN_UART_BASE + (nr*0x400));
}
static inline SQ8612_TIMERS * SQ8612_GetBase_TIMERS(void)
{
	return (SQ8612_TIMERS *)ELFIN_TIMER_BASE;
}
/*
static inline SQ8612_USB_DEVICE * SQ8612_GetBase_USB_DEVICE(void)
{
	return (SQ8612_USB_DEVICE *)ELFIN_USB_DEVICE_BASE;
}
*/
static inline SQ8612_WATCHDOG * SQ8612_GetBase_WATCHDOG(void)
{
	return (SQ8612_WATCHDOG *)ELFIN_WATCHDOG_BASE;
}
static inline SQ8612_I2C * SQ8612_GetBase_I2C(void)
{
	return (SQ8612_I2C *)ELFIN_I2C_BASE;
}
static inline SQ8612_I2S * SQ8612_GetBase_I2S(void)
{
	return (SQ8612_I2S *)ELFIN_I2S_BASE;
}
static inline SQ8612_GPIO * SQ8612_GetBase_GPIO(void)
{
	return (SQ8612_GPIO *)ELFIN_GPIO_BASE;
}
static inline SQ8612_RTC * SQ8612_GetBase_RTC(void)
{
	return (SQ8612_RTC *)ELFIN_RTC_BASE;
}
static inline S3C2410_ADC * S3C2410_GetBase_ADC(void)
{
	return (S3C2410_ADC *)ELFIN_ADC_BASE;
}
static inline SQ8612_SPI * SQ8612_GetBase_SPI(void)
{
	return (SQ8612_SPI *)ELFIN_SPI_BASE;
}
#if 0
