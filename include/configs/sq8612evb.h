 ...
 *
 * Configuation settings for the SQ SMDK6400(mDirac-III) board.
 *
 ...
 * (easy to change)
 */
#define CONFIG_SQ8612		1		/* in a SQ SQ8612 SoC */
#define CONFIG_SQ8612EVB	1		/* on a SQ SQ8612EVB Board */
...
#define virt_to_phys(x)	virt_to_phy_sq8612evb(x)
#else
...
#undef CONFIG_SQ8612_I2C		/* this board has H/W I2C */
#ifdef CONFIG_SQ8612_I2C
...
#define CFG_PROMPT		"SQ8612EVB # "	/* Monitor Command Prompt	*/
...
#define CONFIG_IDENT_STRING	" for SQ8612EVB"
...
extern int SQGetDataFromUsbAndWriteNand(unsigned max_len, unsigned offset, unsigned MaxNandSize, const char *Name);
extern void SQMenu(void);
extern unsigned int SQGetNandSizeInMB(void);
