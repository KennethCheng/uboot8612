...
#if defined(CONFIG_S3C6400) || defined(CONFIG_SQ8612) || defined(CONFIG_S3C6430)
...
#elif defined(CONFIG_SQ8612) || defined(CONFIG_S3C6430)
...
extern ulong virt_to_phy_sq8612evb(ulong addr);
